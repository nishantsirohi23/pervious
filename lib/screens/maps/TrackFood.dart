...
class TrackFood extends StatefulWidget {
  ...
  const TrackFood({Key? key,required this.destlat,required this.destlong,required this.sourcelat,required this.sourcelong,required this.orderId}) : super(key: key);

  @override
  State<TrackFood> createState() => _NavigationState(destlat, destlong, sourcelat, sourcelong);
}

class _NavigationState extends State<TrackFood> {
  final double destlat;
  final double destlong;
  final double sourcelat;
  final double sourcelong;
  ...
  Future<void> refreshPaymentDate() async {
    ...
    if(paymentdone){
      setState(() {
        showbill = true;
        totalamount = workSnapshot['orderamount'];
...
// Close the dialog
  ...
  void getStreamData() async {
    FirebaseFirestore.instance.collection('orders').doc(widget.orderId).snapshots().listen((DocumentSnapshot snapshot) async {
          ...
          children: <Widget>[
            ...
            Visibility(
              ...
              child: Container(
                ...
                child: ShowBill(deliveryfee: deliveryfee.toString(),gst: 0.toString(),finalworkeramount: totalamount.toString(),grandtotal: (deliveryfee+totalamount+5).toString(),),
              ),
            ),
            Visibility(
              visible: !paymentdone,
              child:GestureDetector(
                onTap: () {
                  ...
                  int grandtotal = deliveryfee+gst+workertip+totalamount+5;
                                  ...
                                  Column(
                                    ...
                                    children: [
                                                    ...
                                                    GestureDetector(
                                                      onTap: (){
                                                        setState(() {
                                                          ...
                                                          grandtotal = deliveryfee.toInt() + gst + workertip +  totalamount + 5;
                                      ...
                                      GestureDetector(
                                        onTap: (){
                                          Navigator.pop(context);
                                          APIs.AddTiptoFood(widget.orderId, grandtotal, workertip);

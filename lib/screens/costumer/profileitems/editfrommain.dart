...
class EditProfileScreenMain extends StatefulWidget {

  const EditProfileScreenMain({Key? key}) : super(key: key);

  @override
  _EditProfileScreenState createState() => _EditProfileScreenState();
}

class _EditProfileScreenState extends State<EditProfileScreenMain> {
  late String _name;
  late String _email;
  late String _mobile;
  late String _image;
  ...
  Future<void> _updateUserInfo() async {setState(() {
    _isLoading = true;
  });
  ...
  try {
    await APIs.updateMyInfomain(newName, newMobile,image);
    MotionToast.success(
      title:  Text("Update Success"),
      description:  Text("Details of the User Successfully updated"),
    ).show(context);

...
class MyReview extends StatefulWidget {
  ...
  @override
  State<MyReview> createState() => _ShowAllReviewState();
}

class _ShowAllReviewState extends State<MyReview> {
  @override
      ...
      body: Column(
        children: [
          ...
          StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection('users').doc(APIs.me.id).collection('reviews').snapshots(),
                ...
                child: SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      String userId = playerData['profId'];

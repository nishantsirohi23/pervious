...
class CompletedBooking extends StatefulWidget {
  ...
  @override
  State<CompletedBooking> createState() => _UserBookingState();
}

class _UserBookingState extends State<CompletedBooking> {
      ...
      child: StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          final List<QueryDocumentSnapshot<Map<String, dynamic>>> userBookings = filteredDocuments
              ...
              .where((doc) => doc['userId'] == user?.uid && doc['type'] == 'hours' && doc['status']=='completed')
              .toList();
          ...
          userBookings.sort((a, b) {
            ...
            return fromDateTimeB.compareTo(fromDateTimeA);
          });
    ...
    return Container(
      ...
      child: StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          final List<QueryDocumentSnapshot<Map<String, dynamic>>> userBookings = filteredDocuments
              .cast<QueryDocumentSnapshot<Map<String, dynamic>>>()
              .where((doc) => doc['userId'] == user?.uid && doc['type'] == 'work' && doc['status']=='completed')
              .toList();
                                                ...
                                                Visibility(
                                                  ...
                                                  child: GestureDetector(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          Icon(Icons.star,color: Colors.pink.shade300,),
                                                          Text("Add Review",
                                                            style: TextStyle(
                                                                color: Colors.pink.shade300,
                                                                fontWeight: FontWeight.w500,

...
class BookingIHaveToDo extends StatefulWidget {
  const BookingIHaveToDo({Key? key}) : super(key: key);

  @override
  State<BookingIHaveToDo> createState() => _UserBookingState();
}

class _UserBookingState extends State<BookingIHaveToDo> {
      ...
      child: StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          final List<QueryDocumentSnapshot<Map<String, dynamic>>> userBookings = filteredDocuments
              ...
              .where((doc) => doc['workerId'] == APIs.me.id&& doc['type'] == 'hours' && doc['status']=='accept' )
              .toList();
    ...
    return Container(
      ...
      child: StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          final List<QueryDocumentSnapshot<Map<String, dynamic>>> userBookings = filteredDocuments
              .cast<QueryDocumentSnapshot<Map<String, dynamic>>>()
              .where((doc) => doc['workerId'] == APIs.me.id && doc['type'] == 'work' && doc['status']=='accept' )
              .toList();
    ...
    return Container(
      ...
      child: StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          final List<QueryDocumentSnapshot<Map<String, dynamic>>> userBookings = filteredDocuments
              .cast<QueryDocumentSnapshot<Map<String, dynamic>>>()
              .where((doc) => doc['workerId'] == APIs.me.id && doc['type'] == 'days' && doc['status']=='accept')
              .toList();
          if (userBookings.isEmpty) {
            return Center(
              child: Container(

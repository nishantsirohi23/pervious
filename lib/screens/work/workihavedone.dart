...
class WorkIHaveDone extends StatefulWidget {
  @override
  _UserInformationState createState() => _UserInformationState();
}

class _UserInformationState extends State<WorkIHaveDone> {
          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                var documents = snapshot.data!.docs.where((document) {
                  var data = document.data() as Map<String, dynamic>?;

                  return data != null &&
                      data.containsKey('assigned') &&
                      data.containsKey('status') &&
                      data['assigned'] == user.uid &&
                  ...
                  return Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        double amount = data['workeramount'];
                        print("woprker amnout");
                        print(amount);
                        double amountToRemove = amount * (7.5 / 100);
                        double newAmount = amount - amountToRemove;
                        int result = newAmount.round();
                        String workImage = "";
...
// At this point, workImage will either be set to the default URL or the URL of the first image of type jpeg, png, or jpg.
                        ...
                        return GestureDetector(
                          onTap: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => ShowWork(workid: data['id'])),
                            );
                          },
                          child: Container(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text("Your Amount ₹ "+result.toString(),style: TextStyle(

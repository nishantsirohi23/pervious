...
class LoginPageWorker extends StatefulWidget {
  const LoginPageWorker({super.key});

  @override
  State<LoginPageWorker> createState() => _LoginPageState();
}

class _LoginPageState extends State<LoginPageWorker>
      ...
      AuthService.loginWithOtp(otp: _otpContoller.text).then((value) {
        if (value == "Success") {
          ...
          Navigator.pushReplacement(
              context, MaterialPageRoute(builder: (context) => PlatformFormScreen(id: APIs.me.id)));
        } else {
          Navigator.pop(context);
